...
local ToggleIconFallback = Instance.new("TextLabel", ToggleIconBadge)
ToggleIconFallback.Size = UDim2.new(1, 0, 1, 0)
ToggleIconFallback.BackgroundTransparency = 1
ToggleIconFallback.Text = "⚔"
ToggleIconFallback.TextColor3 = Color3.new(1, 1, 1)
ToggleIconFallback.Font = Enum.Font.GothamBold
ToggleIconFallback.TextSize = 16
...
local function setOpen(v)
    ...
    ToggleIconFallback.Text = v and "✕" or "⚔"
